...
class Executor:
    ...
    def question(self, key, lang):
        spoken_identifiers = {
            'phone': {
                'ru': 'Назовите полный номер телефона с кодом плюс семь, можно по группам цифр.',
                'kk': 'Телефон нөмірін плюс жеті кодымен толық айтыңыз, цифрларды топтап айтуға болады.',
            },
            'vehicle_plate': {
                'ru': 'Назовите госномер автомобиля, буквы произнесите по отдельности.',
                'kk': 'Көліктің мемлекеттік нөмірін айтыңыз, әріптерді жеке-жеке атаңыз.',
            },
            'culprit_vehicle_plate': {
                'ru': 'Назовите госномер машины виновника, буквы произнесите по отдельности.',
                'kk': 'Кінәлі көліктің нөмірін айтыңыз, әріптерді жеке-жеке атаңыз.',
            },
            'iin': {
                'ru': 'Назовите все двенадцать цифр ИИН, можно по группам.',
                'kk': 'ЖСН-нің он екі цифрын толық айтыңыз, топтап айтуға болады.',
            },
            'drivers_iin': {
                'ru': 'Назовите все двенадцать цифр ИИН каждого водителя, можно по группам.',
                'kk': 'Әр жүргізушінің ЖСН-інің он екі цифрын толық айтыңыз, топтап айтуға болады.',
            },
            'new_driver_iin': {
                'ru': 'Назовите все двенадцать цифр ИИН нового водителя, можно по группам.',
                'kk': 'Жаңа жүргізушінің ЖСН-інің он екі цифрын толық айтыңыз, топтап айтуға болады.',
            },
            'policy_number': {
                'ru': 'Назовите номер полиса целиком, буквенные части произнесите по буквам.',
                'kk': 'Полис нөмірін толық айтыңыз, әріптік бөліктерді жеке-жеке атаңыз.',
            },
            'claim_number': {
                'ru': 'Назовите номер заявления целиком, включая буквы и шесть цифр.',
                'kk': 'Өтініш нөмірін толық айтыңыз, әріптері мен алты цифрын қоса атаңыз.',
            },
        }
        if key in spoken_identifiers:
            return spoken_identifiers[key][lang]
